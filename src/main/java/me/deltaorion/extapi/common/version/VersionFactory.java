...
public class VersionFactory {
    ...
    /**
     * Parses a version string from {@link Server#getVersion()} into a minecraft version
     *
    ...
    /**
     * Parses a version String from {@link ProxyServer#getVersion()} into a minecraft version
     *
     * @param version The bungee version string
     * @return A minecraft version
     */
    ...
    private static VersionParser BUNGEE_PARSER = new VersionParser() {

...
public class SyncBukkitCommand implements TabExecutor {
    ...
    @NotNull private final me.deltaorion.extapi.command.Command command;

    public SyncBukkitCommand(@NotNull ApiPlugin plugin, @NotNull me.deltaorion.extapi.command.Command command) {

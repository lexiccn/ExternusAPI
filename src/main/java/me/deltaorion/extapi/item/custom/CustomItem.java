...
public class CustomItem implements Listener {
     ...
     * Not all possible item events outcomes are covered by the {@link me.deltaorion.extapi.item.wrapper.CustomEventWrapper}
     * and not all predicates by {@link me.deltaorion.extapi.item.predicate.EventCondition}. To register any {@link CustomItemEventListener}

...
import me.deltaorion.bukkit.protocol.WrapperPlayServerEntityDestroy;
import me.deltaorion.bukkit.protocol.WrapperPlayServerEntityMetadata;
import me.deltaorion.bukkit.protocol.WrapperPlayServerEntityTeleport;
import me.deltaorion.bukkit.protocol.WrapperPlayServerSpawnEntityLiving;
...
/**
 * Represents a fake wither. That is a wither that does not actually exist or interact with the world but merely
 * a wither that a singular play can see.
 *
 * @author aadnk, DeltaOrion
 *
 * //https://gist.github.com/aadnk/9373802 Original source code.
 */

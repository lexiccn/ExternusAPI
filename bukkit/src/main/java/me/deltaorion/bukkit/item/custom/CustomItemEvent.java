 ...
 *   - the extracted entity from the event as defined by the listeners {@link me.deltaorion.bukkit.item.wrapper.CIEventWrapper}
 *   - All custom items that met the predicate
 *   - The actual event that was listened to
 *   - The custom item that this is related to
 *
 *  If multiple items meet the specified {@link me.deltaorion.bukkit.item.predicate.EventPredicate} and they are all custom,
...
public class CustomItemEvent<T extends Event> {
    ...
    /**
     *
     * @return All ItemStacks in the entities inventory in that meet the listeners {@link me.deltaorion.bukkit.item.predicate.EventPredicate}

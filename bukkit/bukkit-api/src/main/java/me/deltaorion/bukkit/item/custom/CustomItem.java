...
public class CustomItem implements Listener {
     ...
     * Not all possible item events outcomes are covered by the {@link CustomEventWrapper}
     * and not all predicates by {@link EventCondition}. To register any {@link CustomItemEventListener}

...
import me.deltaorion.common.plugin.BaseApiPlugin;
...
public class TestPlugin implements ApiPlugin {
    ...
    public TestPlugin(EServer server) {
        ...
        this.baseApiPlugin.registerParser(TestEnum.class, TestArgumentParsers.TEST_PARSER());
    }
    ...
    public void setTranslator(TranslationManager manager) {
        baseApiPlugin.setTranslator(manager);
    }

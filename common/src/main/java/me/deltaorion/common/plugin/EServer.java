...
public interface EServer {
    ...
    @Nullable
    EPlugin getPlugin(@NotNull String name);

    @Nullable
    Object getPluginObject(@NotNull String name);
    ...
    String translateColorCodes(@NotNull String textToTranslate);
    ...
    @NotNull
    Sender wrapSender(@NotNull Object commandSender);
     ...
     */
    void setSenderFactory(@NotNull SenderFactory factory);
}
